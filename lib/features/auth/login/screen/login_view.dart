          ...
          children: [
            SafeArea(child: ListView(
              ...
              children: [Text('Masuk',
                  ...
                  Text('Masukan kredensial anda untuk masuk ke akun',
                      style: AppTextStyle.body2Medium
                          .copyWith(color: Colors.black)),
                          InputLayout('Email',TextFormField(onChanged: (String value) => (() {}),
                        //validator: noEmptyValidator,
                        decoration:
                            customInputDecoration('Masukkan alamat email anda'))),InputLayout(
                      'Password',
                      TextFormField(
